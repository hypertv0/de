...
class AdvancedKoolResolver:
    def __init__(self):
        ...
        self.resolve_url = "https://www.kool.to/mediahubmx-resolve.json" # Not: Gerekirse bu da proxy'lenebilir.
    ...
    def get_auth_signature(self, link):
        ...
        try:
            ...
            resp = self.session.post(self.ping_url, json=json_to_send, headers=self.ping_headers, timeout=30)
    ...
    def resolve_kool_link(self, link):
        ...
        # Resolve isteği için gerekli olan başlıkları (headers) tam olarak taklit ediyoruz.
        resolve_headers = {
